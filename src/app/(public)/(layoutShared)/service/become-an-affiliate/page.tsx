  ...
  const sectionAbout = [
    {
      ...
      img: sectionImg1,
      title: "Authors",
      content: "Promote your book via Bookshop to support your writing career and independent bookstores at the same time."
    },
    {
      id: 2,
      img: sectionImg2,
  ...
  return <>
    ...
    <div className="banner relative" id="banner">
      ...
      <div className="flex h-full w-1/3 justify-center flex-col text-white z-10 absolute top-0 ml-[8rem]">
        ...
        <div>
          <Link href="" className="inline-block button primary text-[1.6rem] font-bold bg-[#DE2454] rounded-[4rem] px-10 py-4 hover:scale-105 hover:bg-[#333] duration-300">
    ...
    <section className="px-10rem section-about">
      <ul className="flex w-4/5 m-auto py-[8rem]">
        {sectionAbout.map((sectionAboutItem: any, index: number) => (
          <li key={index} className="w-1/3 flex flex-col justify-items-start items-center text-center">
            <div>
    ...
    <section className="section-howitworks bg-[#EAE9ED] py-[6rem]">
      <div className="flex justify-center items-center w-[90%] m-auto">
        ...
        <div className="w-1/2 pl-[10rem]">
          ...
          <ul className="my-10">
            {sectionHowItWorks.map((sectionHowItWorkItem: any, index: number) => (
              <li key={index} className="flex text-[1.8rem] mb-6 items-center">
          ...
          <h2 className="text-4xl font-bold text-[#2B0F42]">{"Want to learn more? Check our"}</h2>
          <h3 className="text-4xl font-bold mt-4">
            <Link href="" className="inline-block text-[#DE2454] hover:underline">{"FAQ"}</Link>
          </h3>
        </div>
      </div>
    </section>
    ...
    <section className="w-1/3 m-auto py-[8rem]">
      ...
      <nav className="text-[1.8rem]">{"Questions? Email"}
        <Link href="" className="text-[#DE2854] px-2 hover:underline">{"affiliates@bookshop.org"}</Link>
        {"to hear more."}
      </nav>
    </section>
    ...
    <section className="relative section-storefront">
      <div className="banner-img h-[45rem] w-full">
        <Image src={sectionStoreFront} alt="Banner Image" className="h-full w-full" />
      </div>
